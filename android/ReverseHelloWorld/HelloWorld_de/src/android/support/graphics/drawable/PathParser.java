    ...
    public static class PathDataNode
    {
        ...
        private static void arcToBezier(final Path path, final double n, final double n2, final double n3, final double n4, double n5, double n6, double cos, double sin, double n7) {
            ...
            while (i < n8) {
                ...
                path.rCubicTo((float)(cos + n7 * n5) - (float)cos, (float)(sin + n7 * n6) - (float)sin, (float)(n14 - n7 * n16) - (float)cos, (float)(n15 - n7 * n17) - (float)sin, (float)n14 - (float)cos, (float)n15 - (float)sin);
                n7 = n13;
                cos = n14;
                sin = n15;
                n5 = n16;
