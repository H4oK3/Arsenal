...
public final class MediaControllerCompat
{
    ...
    public MediaControllerCompat(final Context context, final MediaSessionCompat.Token mToken) throws RemoteException {
        ...
        if (Build$VERSION.SDK_INT >= 26) {
            this.mImpl = (MediaControllerImpl)new MediaControllerImplApi26(context, mToken);
            return;
        }
    ...
    public MediaControllerCompat(final Context context, final MediaSessionCompat mediaSessionCompat) {
        ...
        if (Build$VERSION.SDK_INT >= 26) {
            this.mImpl = (MediaControllerImpl)new MediaControllerImplApi26(context, mediaSessionCompat);
            return;
        }
        if (Build$VERSION.SDK_INT >= 24) {
    ...
    public abstract static class Callback implements IBinder$DeathRecipient
    {
        ...
        public Callback() {
            ...
            if (Build$VERSION.SDK_INT >= 26) {
                this.mCallbackObj = MediaControllerCompatApi26.createCallback((MediaControllerCompatApi26.Callback)new StubApi26());
                return;
            }
            if (Build$VERSION.SDK_INT >= 21) {
        ...
        private class StubApi26 extends StubApi21 implements MediaControllerCompatApi26.Callback
        {
            @Override
            public void onRepeatModeChanged(final int n) {
                MediaControllerCompat.Callback.this.onRepeatModeChanged(n);
            }
            
            @Override
            public void onShuffleModeChanged(final boolean b) {
                MediaControllerCompat.Callback.this.onShuffleModeChanged(b);
            }
        }
        ...
        public int getRepeatMode() {
            if (this.mExtraBinder != null) {
                try {
                    ...
                    Log.e("MediaControllerCompat", "Dead object in getRepeatMode. " + ex);
                }
            }
            return 0;
        }
        ...
        public boolean isShuffleModeEnabled() {
            if (this.mExtraBinder != null) {
                try {
                    ...
                    Log.e("MediaControllerCompat", "Dead object in isShuffleModeEnabled. " + ex);
                }
            }
            return false;
        }
    ...
    {
        MediaControllerImplApi26(final Context context, final MediaSessionCompat.Token token) throws RemoteException {
            super(context, token);
        }
        
        MediaControllerImplApi26(final Context context, final MediaSessionCompat mediaSessionCompat) {
            super(context, mediaSessionCompat);
        }
        ...
        public TransportControls getTransportControls() {
            final Object transportControls = MediaControllerCompatApi21.getTransportControls(this.mControllerObj);
            if (transportControls != null) {
                return new TransportControlsApi26(transportControls);
            }
            return null;
        }
    ...
    static class MediaControllerImplBase implements MediaControllerImpl
    {
        ...
        public void addQueueItem(final MediaDescriptionCompat mediaDescriptionCompat) {
            try {
                ...
                Log.e("MediaControllerCompat", "Dead object in addQueueItem. " + ex);
                return;
            }
        ...
        public void addQueueItem(final MediaDescriptionCompat mediaDescriptionCompat, final int n) {
            try {
                ...
                Log.e("MediaControllerCompat", "Dead object in addQueueItemAt. " + ex);
                return;
            }
        ...
        public void removeQueueItem(final MediaDescriptionCompat mediaDescriptionCompat) {
            try {
                ...
                Log.e("MediaControllerCompat", "Dead object in removeQueueItem. " + ex);
                return;
            }
        ...
        public void removeQueueItemAt(final int n) {
            try {
                ...
                Log.e("MediaControllerCompat", "Dead object in removeQueueItemAt. " + ex);
                return;
            }
    ...
    {
        TransportControlsApi26(final Object o) {
            super(o);
        }
        
        @Override
        public void setRepeatMode(final int n) {
            MediaControllerCompatApi26.TransportControls.setRepeatMode(this.mControlsObj, n);
        }
        
        @Override
        public void setShuffleModeEnabled(final boolean b) {
            MediaControllerCompatApi26.TransportControls.setShuffleModeEnabled(this.mControlsObj, b);
        }
    }
    ...
    static class TransportControlsBase extends TransportControls
    {
        ...
        public void setRepeatMode(final int repeatMode) {
            try {
                ...
                Log.e("MediaControllerCompat", "Dead object in setRepeatMode. " + ex);
            }
        }
        ...
        public void setShuffleModeEnabled(final boolean shuffleModeEnabled) {
            try {
                ...
                Log.e("MediaControllerCompat", "Dead object in setShuffleModeEnabled. " + ex);
            }
        }
