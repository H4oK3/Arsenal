...
public class MediaSessionCompat
{
    ...
    public abstract static class Callback
    {
        ...
        public Callback() {
            if (Build$VERSION.SDK_INT >= 26) {
                this.mCallbackObj = MediaSessionCompatApi26.createCallback((MediaSessionCompatApi26.Callback)new StubApi26());
                return;
            }
        ...
        private class StubApi26 extends StubApi24 implements MediaSessionCompatApi26.Callback
        {
            @Override
            public void onSetRepeatMode(final int n) {
                MediaSessionCompat.Callback.this.onSetRepeatMode(n);
            }
            
            @Override
            public void onSetShuffleModeEnabled(final boolean b) {
                MediaSessionCompat.Callback.this.onSetShuffleModeEnabled(b);
            }
        }
    }
                    ...
                    Label_0061: {
                        ...
                        while (true) {
                            try {
                                ...
                                MediaSessionCompatApi26.setRepeatMode(this.mSessionObj, mRepeatMode);
                                return;
                                this.mExtraControllerCallbacks.finishBroadcast();
                            }
                            catch (RemoteException ex) {
                    ...
                    Label_0061: {
                        ...
                        while (true) {
                            try {
                                ...
                                this.mExtraControllerCallbacks.finishBroadcast();
                                return;
                                MediaSessionCompatApi26.setShuffleModeEnabled(this.mSessionObj, mShuffleModeEnabled);
                            }
                            catch (RemoteException ex) {
                                continue;
                            }
