...
public class NotificationCompat
{
    ...
    public static class Builder
    {
        ...
        public Builder setChannel(final String mChannelId) {
                ...
                try {
                    if (bundle.containsKey("text")) {
                        if (bundle.containsKey("time")) {
                            Message message2;
                            final Message message = message2 = new Message(bundle.getCharSequence("text"), bundle.getLong("time"), bundle.getCharSequence("sender"));
