...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater$Factory2
{
    ...
    public List<Fragment> getFragments() {
        final ArrayList<Object> list = (ArrayList<Object>)new ArrayList<Fragment>();
        if (this.mActive != null) {
            list.addAll(this.mActive);
        }
                                        ...
                                        while (true) {
                                            switch (fragment.mState) {
                                                ...
                                                case 0: {
                                                    ...
                                                    if (fragment.mTarget != null) {
                                                        if (!this.mActive.contains(fragment.mTarget)) {
            ...
            if (fragmentManagerState.mActive != null) {
                ...
                if (fragmentManagerState.mAdded != null) {
                    ...
                    for (int k = 0; k < fragmentManagerState.mAdded.length; ++k) {
                        final Fragment fragment2 = this.mActive.get(fragmentManagerState.mAdded[k]);
                        if (fragment2 == null) {
    ...
    FragmentManagerNonConfig retainNonConfig() {
        ...
        return new FragmentManagerNonConfig(list, list3);
    }
    ...
    public void setPrimaryNavigationFragment(final Fragment mPrimaryNav) {
        if (mPrimaryNav != null && (mPrimaryNav.getFragmentManager() != this || mPrimaryNav.mIndex >= this.mActive.size() || this.mActive.get(mPrimaryNav.mIndex) != mPrimaryNav)) {
