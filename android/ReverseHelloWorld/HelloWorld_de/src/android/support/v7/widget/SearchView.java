...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView
{
    ...
    public SearchView(final Context context, final AttributeSet set, int inputType) {
        ...
        ViewCompat.setTooltipText((View)this.mSearchButton, this.getResources().getString(R.string.abc_searchview_description_search));
                    ...
                    while (true) {
                        ...
                        Label_0206: {
                            try {
                                ...
                                final String s3 = this.mSearchable.getSuggestIntentData();
                                while (true) {
                                    Label_0057: {
                                        break Label_0057;
