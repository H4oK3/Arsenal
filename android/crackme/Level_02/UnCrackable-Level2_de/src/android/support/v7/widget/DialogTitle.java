    ...
    protected void onMeasure(final int n, final int n2) {
        ...
        if (layout != null) {
            ...
            if (lineCount > 0 && layout.getEllipsisCount(lineCount - 1) > 0) {
                ...
                this.setMaxLines(2);
                final TypedArray obtainStyledAttributes = this.getContext().obtainStyledAttributes((AttributeSet)null, a.j.TextAppearance, 16842817, 16973892);
                final int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(a.j.TextAppearance_android_textSize, 0);
