...
class l
{
    ...
    static void a(final LayoutInflater layoutInflater, final n n) {
        ...
        a(layoutInflater, (LayoutInflater$Factory2)factory2);
    }
    ...
    static void a(final LayoutInflater p0, final LayoutInflater$Factory2 p1) {
        ...
        // Original Bytecode:
        // 
        //     0: getstatic       android/support/v4/g/l.b:Z
        //     3: ifne            27
        ...
        //    13: putstatic       android/support/v4/g/l.a:Ljava/lang/reflect/Field;
        //    16: getstatic       android/support/v4/g/l.a:Ljava/lang/reflect/Field;
        //    19: iconst_1       
        //    20: invokevirtual   java/lang/reflect/Field.setAccessible:(Z)V
        //    23: iconst_1       
        //    24: putstatic       android/support/v4/g/l.b:Z
        //    27: getstatic       android/support/v4/g/l.a:Ljava/lang/reflect/Field;
        //    30: ifnull          41
        //    33: getstatic       android/support/v4/g/l.a:Ljava/lang/reflect/Field;
        //    36: aload_0        
        //    37: aload_1        
    ...
    static class a extends k.a implements LayoutInflater$Factory2
    {
        ...
        public View onCreateView(final View view, final String s, final Context context, final AttributeSet set) {
            return this.a.a(view, s, context, set);
        }
    }
}
