...
.method private a(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Landroid/support/v4/g/ae;->s(Landroid/view/View;)Z
    ...
    invoke-direct {v2, p1, v1}, Landroid/support/v7/app/m$a;-><init>(Landroid/view/View;Ljava/lang/String;)V
...
.method public final a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :cond_0
    invoke-static {v0, p4, p6, p7}, Landroid/support/v7/app/m;->a(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/as;->a(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-direct {p0, v0, p2, p4}, Landroid/support/v7/app/m;->a(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-direct {p0, v0, p4}, Landroid/support/v7/app/m;->a(Landroid/view/View;Landroid/util/AttributeSet;)V
