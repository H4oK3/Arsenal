...
.method public constructor <init>(Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ag;->a(Landroid/view/View;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ag;->b(Landroid/view/View;)V

    goto :goto_0
.end method

.method static synthetic a(Landroid/support/v7/widget/ag;)V
    .locals 0
...
.method private a(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ag;->c:Landroid/view/View;
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/ag$a;-><init>(Landroid/support/v7/widget/ag;)V
    ...
    iget v3, p0, Landroid/support/v7/widget/ag;->d:I
    ...
    :pswitch_1
    iget v3, p0, Landroid/support/v7/widget/ag;->h:I
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/ag;->f()V
...
.method private a(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ag;->i:[I
...
.method private b(Landroid/view/View;)V
    ...
    new-instance v1, Landroid/support/v7/widget/ag$2;

    invoke-direct {v1, p0}, Landroid/support/v7/widget/ag$2;-><init>(Landroid/support/v7/widget/ag;)V
...
.method private b(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ag;->c:Landroid/view/View;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ae;->isShown()Z
    ...
    invoke-direct {p0, v3, v4}, Landroid/support/v7/widget/ag;->b(Landroid/view/View;Landroid/view/MotionEvent;)Z

    invoke-direct {p0, v0, v4}, Landroid/support/v7/widget/ag;->a(Landroid/view/View;Landroid/view/MotionEvent;)Z

    iget v3, p0, Landroid/support/v7/widget/ag;->h:I

    invoke-virtual {v0, v4, v3}, Landroid/support/v7/widget/ae;->a(Landroid/view/MotionEvent;I)Z
