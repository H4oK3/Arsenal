...
.field private j:Landroid/support/v4/g/as;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-boolean p2, p0, Landroid/support/v7/widget/ae;->h:Z

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ae;->setCacheColorHint(I)V
...
.method private a(Landroid/view/View;IFF)V
    ...
    iput-boolean v3, p0, Landroid/support/v7/widget/ae;->i:Z
    ...
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/ae;->setPressed(Z)V
    ...
    :cond_2
    iput p2, p0, Landroid/support/v7/widget/ae;->f:I
    ...
    :cond_4
    invoke-virtual {p0, p2, p1, p3, p4}, Landroid/support/v7/widget/ae;->a(ILandroid/view/View;FF)V

    invoke-virtual {p0, v4}, Landroid/support/v7/widget/ae;->setSelectorEnabled(Z)V
...
.method private d()V
    ...
    iput-boolean v2, p0, Landroid/support/v7/widget/ae;->i:Z

    invoke-virtual {p0, v2}, Landroid/support/v7/widget/ae;->setPressed(Z)V
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ae;->j:Landroid/support/v4/g/as;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ae;->j:Landroid/support/v4/g/as;
...
.method protected a()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/ae;->i:Z

    if-nez v0, :cond_0

    invoke-super {p0}, Landroid/support/v7/widget/aj;->a()Z
...
.method public a(Landroid/view/MotionEvent;I)Z
    ...
    :cond_1
    invoke-direct {p0}, Landroid/support/v7/widget/ae;->d()V

    :cond_2
    if-eqz v3, :cond_7

    iget-object v0, p0, Landroid/support/v7/widget/ae;->k:Landroid/support/v4/widget/k;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ae;->k:Landroid/support/v4/widget/k;
    ...
    invoke-virtual {p0, v5, v4}, Landroid/support/v7/widget/ae;->pointToPosition(II)I
    ...
    invoke-direct {p0, v0, v6, v5, v4}, Landroid/support/v7/widget/ae;->a(Landroid/view/View;IFF)V

    if-ne v3, v2, :cond_0

    invoke-direct {p0, v0, v6}, Landroid/support/v7/widget/ae;->a(Landroid/view/View;I)V
...
.method public hasFocus()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/ae;->h:Z

    if-nez v0, :cond_0

    invoke-super {p0}, Landroid/support/v7/widget/aj;->hasFocus()Z
...
.method public hasWindowFocus()Z
    ...
    invoke-super {p0}, Landroid/support/v7/widget/aj;->hasWindowFocus()Z
...
.method public isFocused()Z
    ...
    invoke-super {p0}, Landroid/support/v7/widget/aj;->isFocused()Z
...
.method public isInTouchMode()Z
    ...
    :cond_0
    invoke-super {p0}, Landroid/support/v7/widget/aj;->isInTouchMode()Z
