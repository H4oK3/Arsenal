...
.field private e:Landroid/support/v7/widget/g;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p1, p2, v0, p3, v7}, Landroid/support/v7/widget/av;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/av;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/x;->e:Landroid/support/v7/widget/g;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/x;->f:Landroid/content/Context;
    ...
    :try_start_0
    sget-object v0, Landroid/support/v7/widget/x;->d:[I
    ...
    invoke-static {v2, p2, v5, p3, v7}, Landroid/support/v7/widget/av;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/av;
    ...
    invoke-virtual {v2, v5, v6}, Landroid/support/v7/widget/av;->f(II)I

    move-result v5

    iput v5, p0, Landroid/support/v7/widget/x;->b:I

    sget v5, Landroid/support/v7/a/a$j;->Spinner_android_popupBackground:I

    invoke-virtual {v2, v5}, Landroid/support/v7/widget/av;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/av;->d(I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/x$b;->a(Ljava/lang/CharSequence;)V

    invoke-virtual {v2}, Landroid/support/v7/widget/av;->a()V

    iput-object v0, p0, Landroid/support/v7/widget/x;->a:Landroid/support/v7/widget/x$b;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/x;->g:Landroid/support/v7/widget/ag;

    :cond_2
    sget v0, Landroid/support/v7/a/a$j;->Spinner_android_entries:I

    invoke-virtual {v4, v0}, Landroid/support/v7/widget/av;->f(I)[Ljava/lang/CharSequence;
    ...
    :cond_3
    invoke-virtual {v4}, Landroid/support/v7/widget/av;->a()V

    iput-boolean v3, p0, Landroid/support/v7/widget/x;->i:Z

    iget-object v0, p0, Landroid/support/v7/widget/x;->h:Landroid/widget/SpinnerAdapter;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/x;->h:Landroid/widget/SpinnerAdapter;

    :cond_4
    iget-object v0, p0, Landroid/support/v7/widget/x;->e:Landroid/support/v7/widget/g;
    ...
    invoke-virtual {v4, v0, v7}, Landroid/support/v7/widget/av;->g(II)I
    ...
    iput-object v2, p0, Landroid/support/v7/widget/x;->f:Landroid/content/Context;
...
.method a(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->c:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/x;->c:Landroid/graphics/Rect;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->g:Landroid/support/v7/widget/ag;
