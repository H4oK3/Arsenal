...
public class LinearLayoutCompat extends ViewGroup
{
    ...
    void measureHorizontal(final int n, final int n2) {
        ...
        this.setMeasuredDimension((0xFF000000 & n38) | resolveSizeAndState, ViewCompat.resolveSizeAndState(Math.max(n40 + (this.getPaddingTop() + this.getPaddingBottom()), this.getSuggestedMinimumHeight()), n2, n38 << 16));
        if (n5 != 0) {
    ...
    void measureVertical(final int n, final int n2) {
        ...
        this.setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(n28 + (this.getPaddingLeft() + this.getPaddingRight()), this.getSuggestedMinimumWidth()), n, n25), resolveSizeAndState);
        if (n4 != 0) {
