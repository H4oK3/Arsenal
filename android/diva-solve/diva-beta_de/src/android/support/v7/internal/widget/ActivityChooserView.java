    ...
    private class ActivityChooserViewAdapter extends BaseAdapter
    {
        ...
        public void setDataModel(final ActivityChooserModel mDataModel) {
            ...
            if (dataModel != null && ActivityChooserView.this.isShown()) {
                dataModel.unregisterObserver((Object)ActivityChooserView.this.mModelDataSetOberver);
            }
            if ((this.mDataModel = mDataModel) != null && ActivityChooserView.this.isShown()) {
                mDataModel.registerObserver((Object)ActivityChooserView.this.mModelDataSetOberver);
            }
