...
public class ToolbarActionBar extends ActionBar
{
    ...
    private void ensureListMenuPresenter(final Menu menu) {
        if (this.mListMenuPresenter == null && menu instanceof MenuBuilder) {
            ...
            (this.mListMenuPresenter = new ListMenuPresenter((Context)contextThemeWrapper, R.layout.abc_list_menu_item_layout)).setCallback(new PanelMenuPresenterCallback());
    ...
    private class ToolbarCallbackWrapper extends WindowCallbackWrapper
    {
        ...
        public View onCreatePanelView(final int n) {
            switch (n) {
                case 0: {
                    final Menu menu = ToolbarActionBar.this.mDecorToolbar.getMenu();
