...
public class NotificationCompatImplBase
{
    ...
    private static RemoteViews applyStandardTemplate(final Context context, final CharSequence charSequence, final CharSequence charSequence2, final CharSequence charSequence3, int n, final Bitmap bitmap, final CharSequence charSequence4, final boolean b, final long n2, int line3, final boolean b2) {
        final RemoteViews remoteViews = new RemoteViews(context.getPackageName(), line3);
        line3 = 0;
        final int n3 = 0;
        ...
        if (line3 != 0 && Build$VERSION.SDK_INT >= 16) {
            if (b2) {
        ...
        if (n2 != 0L) {
            if (b) {
                ...
                remoteViews.setLong(R.id.chronometer, "setBase", SystemClock.elapsedRealtime() - System.currentTimeMillis() + n2);
    ...
    private static <T extends NotificationCompatBase.Action> RemoteViews generateContentView(final Context context, final CharSequence charSequence, final CharSequence charSequence2, final CharSequence charSequence3, int min, final Bitmap bitmap, final CharSequence charSequence4, final boolean b, final long n, final List<T> list, final int[] array, final boolean b2, final PendingIntent pendingIntent) {
        final RemoteViews applyStandardTemplate = applyStandardTemplate(context, charSequence, charSequence2, charSequence3, min, bitmap, charSequence4, b, n, R.layout.notification_template_media, true);
