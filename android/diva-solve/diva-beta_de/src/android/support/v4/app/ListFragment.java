...
public class ListFragment extends Fragment
{
    ...
    private void setListShown(final boolean mListShown, final boolean b) {
        ...
        if (mListShown) {
            if (b) {
                this.mProgressContainer.startAnimation(AnimationUtils.loadAnimation((Context)this.getActivity(), 17432577));
                this.mListContainer.startAnimation(AnimationUtils.loadAnimation((Context)this.getActivity(), 17432576));
            }
            else {
        ...
        if (b) {
            this.mProgressContainer.startAnimation(AnimationUtils.loadAnimation((Context)this.getActivity(), 17432576));
            this.mListContainer.startAnimation(AnimationUtils.loadAnimation((Context)this.getActivity(), 17432577));
        }
        else {
            this.mProgressContainer.clearAnimation();
            this.mListContainer.clearAnimation();
