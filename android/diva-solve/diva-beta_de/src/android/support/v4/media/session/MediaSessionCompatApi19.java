...
class MediaSessionCompatApi19
{
    ...
    public static Object createMetadataUpdateListener(final MediaSessionCompatApi14.Callback callback) {
    ...
    static class OnMetadataUpdateListener<T extends MediaSessionCompatApi14.Callback> implements RemoteControlClient$OnMetadataUpdateListener
    {
        ...
        public void onMetadataUpdate(final int n, final Object o) {
            if (n == 268435457 && o instanceof Rating) {
                ((MediaSessionCompatApi14.Callback)this.mCallback).onSetRating(o);
            }
        }
    }
}
