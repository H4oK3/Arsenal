    ...
    private void setupAnimators() {
        ...
        final Animation mAnimation = new Animation() {
            public void applyTransformation(final float n, final Transformation transformation) {
                ...
                final float access$100 = MaterialProgressDrawable.this.getMinProgressArc(mRing);
                ...
                if (n <= 0.5f) {
                    mRing.setStartTrim(startingStartTrim + (0.8f - access$100) * MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(n / 0.5f));
                }
                if (n > 0.5f) {
                    mRing.setEndTrim(startingEndTrim + MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation((n - 0.5f) / 0.5f) * (0.8f - access$100));
                }
