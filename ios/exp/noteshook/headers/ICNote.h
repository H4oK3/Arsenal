...
* on Wednesday, October 4, 2017 at 4:18:09 PM Eastern Daylight Time
* Operating System: Version 9.0.1 (Build 13A405)
* Image Source: /System/Library/PrivateFrameworks/NotesShared.framework/NotesShared
* classdump-dyld is licensed under GPLv3, Copyright © 2013-2016 by Elias Limneos.
*/


@protocol ICNoteUndoSupport
@required
...
@interface ICNote : ICCloudSyncingObject <ICNoteUndoSupport, ICSearchIndexableNote, ICCloudObject, TTTextStorageDelegate, NSTextStorageDelegate> {
...
+(void)createNoteForAirDropDocument:(id)arg1 completion:(/*^block*/id)arg2 ;
...
-(UIImage*)thumbnailImageWithMinSize:(CGSize)arg1 scale:(double)arg2 imageScaling:(unsigned long long*)arg3 showAsFileIcon:(BOOL*)arg4 isMovie:(BOOL*)arg5 movieDuration:(SCD_Struct_IC0*)arg6 ;
